...
const experiences = [
  ...
  // },
  {
    ...
    // company_name: "Verdex Tech",
    icon: "/assets/company/curowell-logo.svg",
    iconBg: "#E6DEDD",
    date: "March 2023 - August 2023",
    points: [
      "Collaborated with a team to develop responsive web interfaces using HTML, CSS, and JavaScript, ensuring cross-platform compatibility and improved user experience.",
      "Maintained and optimized codebase, implementing best practices to enhance website performance by 20%.",
      "Assisted in debugging and troubleshooting web applications, improving functionality and reducing downtime.",
      "Contributed to the creation of reusable UI components using frameworks like React, streamlining future development efforts.",
    ],
  },
  {
    title: "Web Developer Intern",
    // company_name: "Tele Tech",
    icon: "/assets/company/drdo-cabs.png",
    iconBg: "#E6DEDD",
    date: "September 2024 - February 2025",
    points: [
      "Developed dynamic and responsive websites for clients using React.js, Tailwind CSS, and Bootstrap, meeting 100% of project deadlines.",
      "Implemented frontend solutions aligned with client requirements, improving user engagement by delivering visually appealing and functional designs.",
      "Participated in client meetings to gather requirements and provide technical insights, ensuring project alignment with business goals.",
      "Improved website loading times by 30% through effective performance optimization techniques.",
    ],
  }
...
const socials = [
  {
    id: "github",
    icon: <GithubIcon />,
    link: "https://github.com/shahzaibhaiderali",
